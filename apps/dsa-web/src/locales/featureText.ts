...
export const PAPER_TRADING_TEXT = {
  zh: {
    ...
    processedAt: '处理时间',
    mechanism: [
      '分析产生 buy/add/sell/reduce 信号时，模拟盘自动开仓/加仓/减仓/清仓；观望等信号忽略',
      '每日自动按现价估值，触发止损/止盈退出（也可手动刷新估值）',
      '选择起始日期可回填历史信号，重放补算历史表现',
    ],
  ...
  en: {
    ...
    mechanism: [
      'When analysis yields buy/add/sell/reduce signals, the paper account opens/adds/reduces/closes positions automatically; watch-like signals are ignored',
      'Mark-to-market and stop-loss/take-profit exits run daily (or on manual refresh)',
      'Pick a start date to backfill and replay historical signals',
    ],
