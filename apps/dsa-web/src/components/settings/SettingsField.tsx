...
function renderFieldControl(
  ...
  const schema = item.schema;
  const commonClass = 'input-surface input-focus-glow h-11 w-full rounded-xl border bg-transparent px-4 text-sm transition-[border-color,background-color,box-shadow] focus:outline-none disabled:cursor-not-allowed disabled:opacity-60';
  ...
  return (
    <div
      className={cn(
        ...
        hasError ? 'bg-danger/5' : 'hover:bg-hover',
      )}
    >
